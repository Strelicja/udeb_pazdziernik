...
get_header(); ?>
	...
	<div id="primary" class="container-fluid content-area">
		<main id="main" class="site-main">
			...
			<div class="row">
				<div class="contact_sidebar_show col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="noPadding  sidebar_contact1 col-lg-8 col-md-8 col-sm-8 col-xs-12">
						<?php
					...
					<!--adress-->
		              <div class="kontakt sidebar_contact widget_text_adres col-lg-4 col-md-4 col-sm-4 col-xs-12">
